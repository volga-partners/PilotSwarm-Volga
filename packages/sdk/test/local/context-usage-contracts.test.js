...
describe("context usage contracts", () => {
    ...
    it("carries context usage through orchestration state and custom status", () => {
        ...
        assertIncludes(orchestration, 'export const CURRENT_ORCHESTRATION_VERSION = "1.0.29";', "latest orchestration should be versioned for context usage changes");
        ...
        assertIncludes(registry, '{ version: "1.0.28", handler: durableSessionOrchestration_1_0_28 },', "previous orchestration version should stay frozen");
    });
